...
function expandArticleBody() {
  ...
  var articleBodies = document.querySelectorAll(".article_body p");

  //create an array of article bodies
  var articleBodiesArray = Array.from(articleBodies);
  buttons.forEach(function (btn) {
    btn.addEventListener("click", function (event) {
      var associatedArticleBody = btn.parentElement.parentElement.parentElement.querySelector(".article_body p");
      ...
      if (btn.innerText = ">") {
        ...
        for (var _i = 0, _articleBodiesArray = articleBodiesArray; _i < _articleBodiesArray.length; _i++) {
          var articleBody = _articleBodiesArray[_i];
        ...
        for (var _i2 = 0, _articleBodiesArray2 = articleBodiesArray; _i2 < _articleBodiesArray2.length; _i2++) {
          var _articleBody = _articleBodiesArray2[_i2];
          if (_articleBody.innerText = associatedArticleBody.innerText) {
